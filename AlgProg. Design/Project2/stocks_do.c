...
int main(int argc, char* argv[])
{
    ...
    if (know_num_stocks == 'y' || know_num_stocks == 'Y')
    {
        ...
        else 
        {
            ...
            {
                stocks_entered++;
                printf("Please enter stock price #%d:  ", stocks_entered);
                scanf("%f", &stock_price);

                if (stock_price < 0 &&  stocks_entered <= num_stocks)
                    continue;
                ...
                if (stock_price >= max_value)
                    max_value = stock_price;
            } while (stocks_entered <= num_stocks);
        }
    ...
    else if (know_num_stocks == 'n' || know_num_stocks == 'N')
    {
        ...
        do
        {
            printf("Please enter stock price #%d:  ", real_num_stocks + 1);
            scanf("%f", &stock_price);
